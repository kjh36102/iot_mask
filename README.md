...
### 기본 형태
`[요청자:4bit][수신자:4bit][요청 코드:12bit][응답상태:4bit][제어코드:8bit]`<br>
...
|코드|10진|설명|기대응답|응답형태|
|-----|-----|------|-------|-----|
|0000 0000 0001|1|마스크 인식 사용가능 여부|사용 가능 여부|0 or 1|
|0000 0000 0010|2|인식 시작 요청|시작 성공 여부|0 or 1|
|0000 0000 0011|3|인식 중단 요청|중단 성공 여부|0 or 1|
|0000 0000 0100|4|인식 결과 요청|인식 결과|0 or 1|
